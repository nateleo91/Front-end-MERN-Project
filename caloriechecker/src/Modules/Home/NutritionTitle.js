...
function NutritionFacts() {
  ...
  */
  ...
  const handleSearchQuery = async (searchText) => {
    await axios
      .get(
        "https://calorie-trakr.herokuapp.com/foods/searchFood?food=" +
          searchText
      )
  ...
  const handleDeleteItem = async (e) => {
    ...
    await axios
      .delete("https://calorie-trakr.herokuapp.com/foods/" + foodId)
      .then((res) => {
        console.log("deleted");
      });
  };
          ...
          <table className="nutInfo">
            <tbody>
              ...
              <tr>
                ...
                <td class="col-2">
                  {`${tempNutritionInfo.saturated_fat || 0}`}g
                </td>
                <td class="col-1">Total Carbs</td>
                <td class="col-2">
                  {`${tempNutritionInfo.carbohydrate || 0}`}g
                </td>
              </tr>
              <tr>
              ...
              <tr class="last">
                ...
                <td class="col-2">
                  {`${tempNutritionInfo.cholesterol || 0}`}mg
                </td>
                <td class="col-1">&nbsp;</td>
                <td class="col-2">&nbsp;</td>
              </tr>
